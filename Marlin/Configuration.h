...
#define STRING_CONFIG_H_AUTHOR "rakosi2" // Who made the changes.
...
//#define PSU_NAME "Power Supply"
  ...
  #define PSU_POWEROFF_GCODE "G1 X0 Y230"  // G-code to run before power-off (e.g., case light off)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42.7, -10, -2 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 210, 210, 20 }
